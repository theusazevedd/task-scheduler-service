...
public class TarefasController {
    ...
    @PostMapping
    public ResponseEntity<TarefaResponseDTO> salvaTarefa(@RequestBody TarefaRequestDTO dto,
                                                         @RequestHeader("Authorization") String token) {
        return ResponseEntity.ok(tarefasService.gravarTarefa(token, dto));
    }

    @GetMapping("/eventos")
    public ResponseEntity<List<TarefaResponseDTO>> buscaListaDeTarefasPorPeriodo(
    ...
    @GetMapping
    public ResponseEntity<List<TarefaResponseDTO>> buscaTarefasPorEmail(@RequestHeader("Authorization") String token) {
    ...
    @PatchMapping
    public ResponseEntity<TarefaResponseDTO> alteraStatusNotificacao(@RequestParam("status") StatusNotificacaoEnum status,
                                                                     @RequestParam("id") String id) {
        return ResponseEntity.ok(tarefasService.alteraStatus(status, id));
    }

    @PutMapping
    public ResponseEntity<TarefaResponseDTO> updateTarefas(@RequestBody TarefaRequestDTO dto,
                                                           @RequestParam("id") String id) {
